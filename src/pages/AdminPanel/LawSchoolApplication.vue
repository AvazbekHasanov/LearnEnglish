<template>
  <div class="p-6 form-container">
        ...
        <div class="grid grid-cols-3 gap-4 section-parent">
          ...
          <section>
            <el-form-item :label="$t('place_of_birth')" prop="birthPlace">
              <el-input v-model="form.birthPlace" :placeholder="$t('place_of_birth')" />
            </el-form-item>
            ...
            <el-form-item
              :label="$t('disability_note')"
              prop="disability_note"
              v-if="form.disability == 'YES'"
            >
              <el-input v-model="form.disabilityNote"> </el-input>
            </el-form-item>
          </section>
      ...
      <div v-show="activeStep === 1">
        <div class="grid grid-cols-3 gap-4 section-parent">
          ...
          <section>
            ...
            <el-form-item :label="$t('education_language')" prop="educationalLanguage">
              <el-select v-model="form.educationalLanguage">
                <el-option label="O'zbek" value="uzbek"></el-option>
                <el-option label="Rus" value="russian"></el-option>
              </el-select>
            </el-form-item>
              ...
              <el-checkbox-group v-model="form.agreements">
                <el-checkbox :label="true">
                  <span>
                    ...
                    <a
                      href="https://lex.uz/uz/docs/-5737476"
                      target="_blank"
                      style="color: #409eff"
                    >
    ...
    <div class="navigation-buttons">
      ...
      <el-button v-if="activeStep == 0" type="primary" @click="validateStep(activeStep)">{{
        $t('next')
      }}</el-button>
      <el-button v-if="activeStep === 1" type="primary" @click="submitForm">{{
        $t('submit')
      }}</el-button>
    </div>
  </div>
...
const rules = {
  ...
  passport: [
    ...
    { pattern: /^[A-Z]{2}-\d{7}$/, message: t('form.errors.passportFormat'), trigger: 'blur' },
  ],
  ...
  disabilityNote: [
    { required: true, message: t('form.errors.disabilityRequired'), trigger: 'change' },
  ],
  ...
  educationalLanguage: [
    { required: true, message: t('form.errors.educationalLanguageRequired'), trigger: 'blur' },
  ],
...
const disabilityValueChanged = () => {
  if (form.disability == 'NO') {
    form.disabilityNote = ''
  }
}
...
const createRequestBody = () => {
  return {
    ...
    educationalLanguage: form.educationalLanguage,
    certificateDate: form.certificateDate ? form.certificateDate : null,
    applicationType: 'LAW_SCHOOL',
    ...
    certificateId: '44eb7f78-19dc-44ed-8828-5742f9e5cb3d',
  }
}
...
const fetchUserData = async () => {
  ...
  try {
    ...
    if (apiData.applicationType !== 'LAW_SCHOOL') {
      router.push('/pages/application')
    }
    ...
    form.disabilityNote = apiData.disabilityNote
    ...
    form.educationalLanguage = apiData.educationalLanguage
    form.status = apiData.status
    form.rejectionReason = apiData.statusComment
    form.applicationType = 'LAW_SCHOOL'
